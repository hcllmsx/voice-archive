...
(function () {
  ...
  L.en = {
    ...
    ui: {
      ...
      statRefHint: 'The ☆ star in each item: mark that clip as the reference audio — when you synthesize new speech later, its voice is used as the timbre reference. Tap again to unmark. Only clips 3–10 seconds long get a star: GPT-SoVITS rejects reference audio outside 3–10 seconds outright.',
      ...
      badRefTip: '{n} starred clip(s) are not 3–10 seconds long — GPT-SoVITS will error out on them. Go back to “Clips”, unstar those, and pick 3–10 second takes instead.',
      toastRefLength: 'Reference audio must be 3–10 seconds long — pick another clip',
